...
<?php
$numberOfTitles = count($orderbooks['list']); // Number of titles
$totalBooks = 0;
    ...
    <div class="layout-px-spacing">
        <div class="card bg-info" style="width: 45rem; margin: 0 auto; border-radius: 10px; overflow: hidden;">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <h5>Name: <?php echo $orderbooks['details']['customer_name']; ?> </h5>
                    <h5>Mobile No: <?php echo $orderbooks['details']['mobile_no']; ?> </h5>
                    <h5>Address: <br> <?php echo $orderbooks['details']['address']; ?> </h5>
                    <h5>City: <?php echo $orderbooks['details']['city']; ?> </h5>
                    <br>
                </li>
                <li class="list-group-item">
                    <h6 style=" font-weight: bold; color:blue;">Courier Charges: <?php echo number_format($orderbooks['details']['courier_charges'],2); ?> </h6>
                <h6>Order Date:
                    <?php
                ...
                <h6>Ship Date: <?php echo date('d-m-Y',strtotime($orderbooks['details']['ship_date']));?></h6>
                <h6><a href="<?php echo$orderbooks['details']['tracking_url']; ?>" target="_blank">
								...
								<thead>
									<tr>
										<td style="border: 1px solid black; padding: 8px;"><b>
											...
											Phone: <?php echo trim(htmlspecialchars($orderbooks['details']['mobile_no'])); ?></b>
										</td>
									</tr>
								</thead>
							</table>
							<!--<textarea id="address" name="address" rows="8" class="form-control" placeholder="Enter Your Address Here" style="font-weight: bold; border: 2px solid black; font-size: 16px">
                                <?php echo trim(htmlspecialchars($orderbooks['details']['address'])); ?>
                            </textarea><br>-->
