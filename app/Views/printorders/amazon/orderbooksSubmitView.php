  ...
  <div class="card radius-12 bg-gradient-purple shadow-lg" style="width: 450px; padding: 48px;">
    <div class="card-body text-center">
      ...
      <div class="d-flex flex-column gap-3">
        <a href="<?= base_url() . 'paperback/paperbackamazonorder' ?>" class="btn btn-success btn-lg">Order Again</a>
        <a href="<?= base_url() . 'paperback/amazonorderbooksstatus' ?>" class="btn btn-success btn-lg">Cancel</a>
      </div>
