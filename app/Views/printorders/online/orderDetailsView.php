                ...
                <div class="card-body p-24 text-start">
                    <ul class="list-group-item">
                        <li class="list-group-item">
                            <h5 class="text-center">Order ID: <?= htmlspecialchars($orderbooks['details']['order_id']) ?></h5>
                        </li>
                        <li class="list-group-item">
            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100 radius-12 bg-gradient-purple" style="padding: 10px;">
                    <div class="card-body p-2">
                        ...
                        <p><strong>Landmark:</strong> <?= htmlspecialchars($orderbooks['details']['shipping_landmark']); ?></p>
                        <p><strong>State:</strong> <?= htmlspecialchars($orderbooks['details']['shipping_state']); ?></p>
                        <p><strong>Pincode:</strong> <?= htmlspecialchars($orderbooks['details']['shipping_pincode']); ?></p>
                        <p><strong>Phone:</strong> <?= htmlspecialchars($orderbooks['details']['shipping_mobile_no']); ?></p>
                        <p><strong>Alt Phone:</strong> <?= htmlspecialchars($orderbooks['details']['shipping_alternate_no']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <tbody style="font-weight: normal;">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php
                                if ($books_details['status'] == 0) echo "In Progress";
                                else if ($books_details['status'] == 1) echo "Shipped";
                                else if ($books_details['status'] == 2) echo "Cancelled";
                                else echo "";
                            ?>
                        </td>
                    </tr>
