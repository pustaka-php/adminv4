            ...
            <div class="widget-content">
                ...
                <div class="table-responsive">
                    <table class="table zero-config">
                        ...
                        <tbody style="">
                            <?php for ($i = 0; $i < sizeof($invoice['pending_invoice_list']); $i++) { 
                                $pending_invoice = $invoice['pending_invoice_list'][$i]; 
                                $del_date = date_create($pending_invoice['delivery_date']);
                                $book_cost = ($pending_invoice['num_pages_quote1'] * $pending_invoice['cost_per_page1']) + ($pending_invoice['num_pages_quote2'] * $pending_invoice['cost_per_page2']) + $pending_invoice['fixed_charge_book'];
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid grey"><?php echo $pending_invoice['book_title']; ?></td>
                                ...
                                <td style="border: 1px solid grey"><?php echo $pending_invoice['num_pages_quote1'] . "/" . number_format($pending_invoice['cost_per_page1'],2); ?><br>
                                    <?php echo $pending_invoice['num_pages_quote2'] . "/" . number_format($pending_invoice['cost_per_page2'],2); ?></td>
                                ...
                                <td style="border: 1px solid grey"><a href="<?php echo base_url();?>pod/pod_publisher_book_create_invoice/<?php echo $pending_invoice['book_id'];?>" class="btn btn-sm btn-info mt-2">Create Invoice</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
