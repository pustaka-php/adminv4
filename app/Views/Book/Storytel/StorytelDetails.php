...
<div id="content" class="main-content">
  <div class="layout-px-spacing">
    ...
    <div class="row gx-4 gy-4 mb-4">
        ...
        $links = [
            'tamil'     => 'book/storytelunpublishedtamil',
            'kannada'   => 'book/storytelunpublishedkannada',
            'telugu'    => 'book/storytelunpublishedtelugu',
            'malayalam' => 'book/storytelunpublishedmalayalam',
            'english'   => 'book/storytelunpublishedenglish'
        ];

        foreach ($logos as $logo):
            $published   = $storytel['scr_'.$logo.'_cnt'] ?? 0;
            $unpublished = $storytel['scr_'.$logo.'_unpub_cnt'] ?? 0;
        ?>
        <div class="col">
        ...
        <div class="col-12">
            <div class="card shadow-none border bg-info-light h-100">
                <div class="card-body p-20">
                    ...
                    <form action="<?= base_url('storytel/storytel_excel/'); ?>" method="post" class="d-flex flex-column gap-2">
