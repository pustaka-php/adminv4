...
<div id="content" class="main-content">
  <div class="layout-px-spacing">
    ...
    // Links for unpublished Storytel audio
    $links = [
        'tamil'     => 'book/storytelaudiounpublished/tamil',
        'kannada'   => 'book/storytelaudiounpublished/kannada',
        'telugu'    => 'book/storytelaudiounpublished/telugu',
        'malayalam' => 'book/storytelaudiounpublished/malayalam',
        'english'   => 'book/storytelaudiounpublished/english'
    ];
    ?>
    ...
    <div class="row gx-4 gy-4 mb-4">
      <?php foreach ($languages as $key => $label): 
          $published   = $storytell['storytel_' . $key . '_cnt'] ?? 0;
          $unpublished = $storytell['storytel_' . $key . '_unpub_cnt'] ?? 0;
      ?>
