...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
        ...
        // Links for unpublished Audible audio
        $links = [
            'tamil'     => 'book/audibleunpublished/1',
            'kannada'   => 'book/audibleunpublished/2',
            'telugu'    => 'book/audibleunpublished/3',
            'malayalam' => 'book/audibleunpublished/4',
            'english'   => 'book/audibleunpublished/5'
        ];
        ?>
        ...
        <div class="row gx-4 gy-4 mb-4">
            <?php foreach ($languages as $key => $label): 
                $published   = $audible['aud_' . $key . '_cnt'] ?? 0;
                $unpublished = $audible['aud_' . $key . '_unpub_cnt'] ?? 0;
            ?>
            ...
            <div class="col-12">
                <div class="card shadow-none border bg-info-light h-100">
                    <div class="card-body p-20">
                        <p class="fw-medium text-primary-light mb-2">Download Audible Audio Book IDs</p>
                        <form action="<?= base_url('audible/audible_audio_excel/'); ?>" 
                              method="post" 
