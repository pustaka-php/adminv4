...
foreach ($logos as $logo):
    $published   = $overdrive['over_'.$logo.'_cnt'] ?? 0;
    $unpublished = $overdrive['over_'.$logo.'_unpub_cnt'] ?? 0;
?>
<div class="col">
        ...
        <div class="col-12">
            <div class="card shadow-none border bg-info-light h-100">
                <div class="card-body p-20">
                    ...
                    <form action="<?= base_url('overdrive/overdrive_excel/'); ?>" method="post" class="d-flex flex-column gap-2">
