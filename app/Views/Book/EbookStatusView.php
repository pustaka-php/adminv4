                                 ...
                                 <!-- Pending -->
                                    ...
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="radius-8 h-100 text-center p-20 bg-success-100">
                                            ...
                                            <h6 class="mb-0"><?= $ebooks_data['total_not_start']; ?></h6>
                                            <a href="<?= base_url(); ?>book/notstartedbooks" class="mt-1 d-inline-block text-success">
                                                <i class="ri-eye-fill"></i> View
                                            </a>
                                        </div>
                                    </div>
                    ...
                    <td>
                        <div class="d-flex flex-column align-items-center border p-2 rounded" style="min-width:80px;">
                            ...
                            <span class="mb-2 fw-bold">
                                <a href="<?= base_url('book/editbook/' . $ebooks_details['book_id']) ?>" 
                                target="_blank" 
                                style="color: blue;">
                                <?= $ebooks_details['book_id']; ?>
                                </a>
                            </span>
