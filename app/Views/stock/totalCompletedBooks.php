    ...
    <div class="layout-px-spacing">
        <div class="page-header">
            <div class="page-title">
                <center><h3>Free Books Completed List</h3></center>
            </div>
        </div>
        <br>
        <table class="table zero-config">
                ...
                <tr>
                    ...
                    <th style="border: 1px solid grey; width: 5%;">Type</th>
                    <th style="border: 1px solid grey; width: 5%;">Purpose</th>
                ...
                <tbody style="font-weight: 800;">
                    ...
                    foreach($print['completed_all'] as $print_book ) { 
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid grey"><?php echo $print_book['type']; ?></td>
                            <td style="border: 1px solid grey"><?php echo $print_book['purpose']; ?></td>
